...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
	...
	describe('withdrawing tokens', () =>{
	  ...
	  describe('failure', async() =>{
	  	...
	  	it('failure for withdrawals with insufficient balances', async () => {
		...
		describe('filling order', async() => {
			...
			describe('success', async () => {
				...
				it('executes the trade and charges fees', async () => {
					...
					balance.toString().should.equal('0', 'user2 Ether is deduced')
					balance = await exchange.balanceOf(token.address, user2)
					balance.toString().should.equal(tokens(0.9).toString(), 'user2 tokens deduced with fees applied')
